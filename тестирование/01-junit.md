...
2. [Сравнение JUnit 4 и JUnit 5](#сравнение-junit-4-и-junit-5)
3. [Аннотации и жизненный цикл тестов](#аннотации-и-жизненный-цикл-тестов)
4. [Assertions — утверждения](#assertions--утверждения)
5. [Параметризованные тесты](#параметризованные-тесты)
6. [Тестовые наборы и теги](#тестовые-наборы-и-теги)
7. [Расширения (Extensions)](#расширения-extensions)
8. [Интеграция с инструментами сборки](#интеграция-с-инструментами-сборки)
