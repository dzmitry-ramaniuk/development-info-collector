...
2. [Введение и зависимости](#введение-и-зависимости)
   - [Maven зависимость](#maven-зависимость)
   - [Gradle зависимость](#gradle-зависимость)
3. [Основные типы тестов](#основные-типы-тестов)
4. [@SpringBootTest — полный контекст](#springboottest--полный-контекст)
   - [Базовый пример](#базовый-пример)
   - [Режимы запуска веб-сервера](#режимы-запуска-веб-сервера)
   - [Пример с RANDOM_PORT и TestRestTemplate](#пример-с-randomport-и-testresttemplate)
   - [Переопределение свойств](#переопределение-свойств)
   - [@MockBean и @SpyBean](#mockbean-и-spybean)
5. [@WebMvcTest — тестирование контроллеров](#webmvctest--тестирование-контроллеров)
   - [Базовый пример](#базовый-пример-1)
   - [Тестирование валидации](#тестирование-валидации)
   - [Тестирование с аутентификацией](#тестирование-с-аутентификацией)
6. [@DataJpaTest — тестирование JPA](#datajpatest--тестирование-jpa)
   - [Базовый пример](#базовый-пример-2)
   - [Использование TestEntityManager](#использование-testentitymanager)
   - [Rollback автоматический](#rollback-автоматический)
7. [@JsonTest — тестирование сериализации](#jsontest--тестирование-сериализации)
   - [Базовый пример](#базовый-пример-3)
   - [Тестирование дат и специальных форматов](#тестирование-дат-и-специальных-форматов)
8. [@JdbcTest — тестирование JDBC](#jdbctest--тестирование-jdbc)
   - [Базовый пример](#базовый-пример-4)
9. [Testcontainers интеграция](#testcontainers-интеграция)
   - [Зависимость](#зависимость)
   - [Пример с PostgreSQL](#пример-с-postgresql)
   - [@SpringBootTest с Testcontainers](#springboottest-с-testcontainers)
10. [Тестирование REST API](#тестирование-rest-api)
   - [TestRestTemplate](#testresttemplate)
   - [WebTestClient (для WebFlux)](#webtestclient-для-webflux)
11. [Практические советы](#практические-советы)
   - [1. Группируй тесты по слоям](#1-группируй-тесты-по-слоям)
   - [2. Избегай @DirtiesContext](#2-избегай-dirtiescontext)
   - [3. Используй профили для тестов](#3-используй-профили-для-тестов)
   - [4. Для тестов БД — Testcontainers](#4-для-тестов-бд--testcontainers)
   - [5. Для REST API — TestRestTemplate или MockMvc](#5-для-rest-api--testresttemplate-или-mockmvc)
   - [6. Для асинхронных операций — Awaitility](#6-для-асинхронных-операций--awaitility)
   - [7. Кешируй контекст между тестами](#7-кешируй-контекст-между-тестами)
   - [8. Используй @Sql для подготовки данных](#8-используй-sql-для-подготовки-данных)
