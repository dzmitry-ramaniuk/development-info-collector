...
3. [🧪 Быстрый выбор инструмента](#-быстрый-выбор-инструмента)
4. [🎯 Как использовать](#-как-использовать)
   ...
   - [Чеклист перед собеседованием](#чеклист-перед-собеседованием)
...
- Умеете объяснить разницу между unit, integration и end-to-end тестами.
...
Если хотите быстро подтянуть практику:
- **JUnit + Mockito** обычно дают самый быстрый вход в тему и хорошо подходят для первых 2–3 дней подготовки.
- **Spring Boot Test + Testcontainers** лучше изучать на примерах собственного проекта или pet-проекта, где видна реальная польза интеграционных тестов.
