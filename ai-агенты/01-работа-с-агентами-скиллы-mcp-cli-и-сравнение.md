...
2. [Введение](#введение)
3. [Как эффективно работать с AI-агентами](#как-эффективно-работать-с-ai-агентами)
   - [Базовый цикл работы](#базовый-цикл-работы)
   - [Что давать агенту на вход](#что-давать-агенту-на-вход)
4. [Скиллы: как конфигурировать и поддерживать](#скиллы-как-конфигурировать-и-поддерживать)
   - [Минимальная структура скилла](#минимальная-структура-скилла)
   - [Правила качественного скилла](#правила-качественного-скилла)
5. [MCP: зачем нужен и как подключать](#mcp-зачем-нужен-и-как-подключать)
6. [CLI-подход: когда удобнее терминал, а не чат](#cli-подход-когда-удобнее-терминал-а-не-чат)
7. [Продуктовая матрица: что именно сравниваем](#продуктовая-матрица-что-именно-сравниваем)
...
8. [Чек-лист собственной оценки](#чек-лист-собственной-оценки)
