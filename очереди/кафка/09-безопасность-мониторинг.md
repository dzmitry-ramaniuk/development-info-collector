...
1. [Безопасность Apache Kafka](#безопасность-apache-kafka)
   - [Введение в безопасность Kafka](#введение-в-безопасность-kafka)
2. [Authentication (Аутентификация)](#authentication-аутентификация)
   - [SSL/TLS](#ssltls)
   - [SASL (Simple Authentication and Security Layer)](#sasl-simple-authentication-and-security-layer)
3. [Authorization (Авторизация)](#authorization-авторизация)
   - [ACL (Access Control Lists)](#acl-access-control-lists)
   - [Kafka Connect ACL](#kafka-connect-acl)
4. [Encryption (Шифрование)](#encryption-шифрование)
   - [Encryption in Transit (SSL/TLS)](#encryption-in-transit-ssltls)
   - [Encryption at Rest](#encryption-at-rest)
5. [Мониторинг Apache Kafka](#мониторинг-apache-kafka)
   - [JMX Метрики](#jmx-метрики)
   - [Prometheus Integration](#prometheus-integration)
   - [Grafana Dashboards](#grafana-dashboards)
   - [Kafka Manager / AKHQ / Confluent Control Center](#kafka-manager-akhq-confluent-control-center)
   - [Logging](#logging)
   - [Alerting](#alerting)
