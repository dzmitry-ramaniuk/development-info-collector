...
3. [Операции обработки](#операции-обработки)
...
4. [State Stores (хранилища состояния)](#state-stores-хранилища-состояния)
...
7. [Обработка ошибок и восстановление](#обработка-ошибок-и-восстановление)
...
11. [Практический пример: Real-time Analytics](#практический-пример-real-time-analytics)
