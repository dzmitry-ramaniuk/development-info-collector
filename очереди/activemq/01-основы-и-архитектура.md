...
2. [Что такое ActiveMQ](#что-такое-activemq)
   - [Историческая справка](#историческая-справка)
   - [Ключевые характеристики](#ключевые-характеристики)
3. [Основные концепции JMS](#основные-концепции-jms)
   - [JMS (Java Message Service)](#jms-java-message-service)
   - [Структура сообщения JMS](#структура-сообщения-jms)
4. [Архитектура ActiveMQ](#архитектура-activemq)
   - [Основные компоненты](#основные-компоненты)
   - [Компоненты брокера](#компоненты-брокера)
5. [Модели обмена сообщениями](#модели-обмена-сообщениями)
   - [Point-to-Point (Queue)](#point-to-point-queue)
   - [Publish-Subscribe (Topic)](#publish-subscribe-topic)
   - [Virtual Destinations](#virtual-destinations)
6. [Протоколы и транспорты](#протоколы-и-транспорты)
   - [Поддерживаемые протоколы](#поддерживаемые-протоколы)
   - [Конфигурация транспортов](#конфигурация-транспортов)
7. [Персистентность и надёжность](#персистентность-и-надёжность)
   - [Режимы доставки](#режимы-доставки)
   - [Хранилища сообщений](#хранилища-сообщений)
   - [Транзакции](#транзакции)
   - [Acknowledgement modes](#acknowledgement-modes)
8. [Пример использования](#пример-использования)
   - [Современный Producer: Artemis и Jakarta Messaging](#современный-producer-artemis-и-jakarta-messaging)
   - [Современный Consumer: Artemis и Jakarta Messaging](#современный-consumer-artemis-и-jakarta-messaging)
   - [Legacy: ActiveMQ Classic 5.x и JMS 1.1/2.0](#legacy-activemq-classic-5x-и-jms-1120)
   - [Конфигурация через Spring](#конфигурация-через-spring)
...
- **Целевая версия или диапазон:** Apache ActiveMQ Classic 6.x и Jakarta Messaging 3.1
- **Статус примеров:** `current`
- **Первичные источники:** [ActiveMQ Classic Documentation](https://activemq.apache.org/components/classic/documentation/); [Jakarta Messaging Specification](https://jakarta.ee/specifications/messaging/)
