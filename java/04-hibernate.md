...
7. [Контекст персистентности (Persistence Context)](#контекст-персистентности-persistence-context)
...
9. [Запросы к данным](#запросы-к-данным)
...
14. [Практические заметки](#практические-заметки)
