...
2. [Архитектура памяти JVM](#архитектура-памяти-jvm)
   - [Heap (Куча)](#heap-куча)
...
3. [Структура Heap подробно](#структура-heap-подробно)
...
4. [Работа сборки мусора](#работа-сборки-мусора)
   - [Minor GC](#minor-gc)
   - [Major GC (Full GC)](#major-gc-full-gc)
   - [Алгоритмы сборки мусора](#алгоритмы-сборки-мусора)
   - [Stop-the-World](#stop-the-world)
5. [Модель памяти JVM](#модель-памяти-jvm)
6. [Типы сборщиков мусора](#типы-сборщиков-мусора)
   - [Serial GC](#serial-gc)
   ...
   - [Сравнение сборщиков мусора](#сравнение-сборщиков-мусора)
7. [Модель памяти JVM](#модель-памяти-jvm-1)
8. [Типы сборщиков мусора](#типы-сборщиков-мусора-1)
9. [Жизненный цикл объекта](#жизненный-цикл-объекта)
10. [Настройка памяти и диагностика](#настройка-памяти-и-диагностика)
11. [Частые проблемы и подходы](#частые-проблемы-и-подходы)
12. [Практические советы](#практические-советы)
