...
2. [Основы анализа сложности](#основы-анализа-сложности)
   - [О-нотация и её виды](#о-нотация-и-её-виды)
   - [Правила вычисления сложности](#правила-вычисления-сложности)
3. [Временная сложность: основные классы](#временная-сложность-основные-классы)
   ...
   - [O(2ⁿ) — экспоненциальная сложность](#o2ⁿ--экспоненциальная-сложность)
4. [Пространственная сложность](#пространственная-сложность)
5. [Амортизированная сложность](#амортизированная-сложность)
6. [Практические примеры анализа](#практические-примеры-анализа)
   - [Пример 1: Поиск наибольшего общего делителя (НОД)](#пример-1-поиск-наибольшего-общего-делителя-нод)
   - [Пример 2: Подсчёт количества установленных бит](#пример-2-подсчёт-количества-установленных-бит)
   - [Пример 3: Нахождение пересечения двух массивов](#пример-3-нахождение-пересечения-двух-массивов)
