...
2. [Экосистема поставок и модульность платформы](#экосистема-поставок-и-модульность-платформы)
3. [Жизненный цикл Java-программы](#жизненный-цикл-java-программы)
4. [Архитектура памяти JVM](#архитектура-памяти-jvm)
5. [Ключевые компоненты исполнения](#ключевые-компоненты-исполнения)
   - [Интерпретатор и JIT](#интерпретатор-и-jit)
   - [Сборка мусора](#сборка-мусора)
   - [Безопасность и верификация](#безопасность-и-верификация)
6. [Инструменты и диагностика](#инструменты-и-диагностика)
7. [Типичные сценарии настройки](#типичные-сценарии-настройки)
