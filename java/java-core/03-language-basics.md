...
2. [Типы данных и литералы](#типы-данных-и-литералы)
3. [Управляющие конструкции](#управляющие-конструкции)
4. [Исключения в Java](#исключения-в-java)
   ...
   - [Best Practices исключений](#best-practices-исключений)
5. [Классы, пакеты и модульность](#классы-пакеты-и-модульность)
6. [Работа со строками и форматированием](#работа-со-строками-и-форматированием)
7. [Ввод/вывод и взаимодействие с окружением](#вводвывод-и-взаимодействие-с-окружением)
