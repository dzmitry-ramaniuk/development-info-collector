...
5. [Терминальные операции](#терминальные-операции)
   ...
   - [toArray](#toarray)
6. [Коллекторы (Collectors)](#коллекторы-collectors)
...
7. [Примитивные стримы](#примитивные-стримы)
...
8. [Параллельные стримы](#параллельные-стримы)
...
11. [Практические примеры](#практические-примеры)
   - [Пример 1: Обработка CSV данных](#пример-1-обработка-csv-данных)
   - [Пример 2: Топ-N элементов](#пример-2-топ-n-элементов)
   - [Пример 3: Валидация и фильтрация](#пример-3-валидация-и-фильтрация)
   - [Пример 4: Построение иерархии](#пример-4-построение-иерархии)
   - [Пример 5: Агрегация с преобразованием](#пример-5-агрегация-с-преобразованием)
