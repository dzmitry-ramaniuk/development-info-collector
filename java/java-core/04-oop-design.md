...
3. [Проектирование классов и API](#проектирование-классов-и-api)
4. [Паттерны проектирования](#паттерны-проектирования)
5. [Работа с интерфейсами и абстракциями](#работа-с-интерфейсами-и-абстракциями)
6. [Архитектурные подходы](#архитектурные-подходы)
