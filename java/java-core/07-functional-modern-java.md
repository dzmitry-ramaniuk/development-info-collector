...
2. [Lambda-выражения и функциональные интерфейсы](#lambda-выражения-и-функциональные-интерфейсы)
...
4. [Optional и null-safety](#optional-и-null-safety)
5. [Современные фичи языка](#современные-фичи-языка)
6. [Реактивное программирование и асинхронность](#реактивное-программирование-и-асинхронность)
7. [Инструменты для функционального стиля](#инструменты-для-функционального-стиля)
...
> **Подробное описание Stream API вынесено в отдельный раздел:** [Stream API](09-stream-api.html)
> 
> В нём вы найдёте:
