...
2. [Проблемы создания потоков напрямую](#проблемы-создания-потоков-напрямую)
3. [ExecutorService: пулы потоков](#executorservice-пулы-потоков)
4. [Кастомизация пулов с ThreadPoolExecutor](#кастомизация-пулов-с-threadpoolexecutor)
5. [Обработка прерываний](#обработка-прерываний)
6. [Виртуальные потоки (Java 19+)](#виртуальные-потоки-java-19)
