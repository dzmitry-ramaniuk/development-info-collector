...
2. [ThreadLocal: состояние, привязанное к потоку](#threadlocal-состояние-привязанное-к-потоку)
3. [Неизменяемость как альтернатива синхронизации](#неизменяемость-как-альтернатива-синхронизации)
