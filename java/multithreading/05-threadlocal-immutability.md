...
1. [ThreadLocal: состояние, привязанное к потоку](#threadlocal-состояние-привязанное-к-потоку)
2. [Неизменяемость как альтернатива синхронизации](#неизменяемость-как-альтернатива-синхронизации)
