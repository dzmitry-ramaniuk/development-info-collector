...
4. [Repository интерфейсы](#repository-интерфейсы)
...
5. [Генерация запросов по имени методов (Query Derivation)](#генерация-запросов-по-имени-методов-query-derivation)
...
6. [Кастомные запросы](#кастомные-запросы)
...
7. [Specifications — гибкое построение запросов](#specifications--гибкое-построение-запросов)
...
9. [Аудит сущностей](#аудит-сущностей)
...
10. [Транзакции в Spring Data](#транзакции-в-spring-data)
...
11. [Поддержка NoSQL](#поддержка-nosql)
   - [Spring Data MongoDB](#spring-data-mongodb)
   - [Spring Data Redis](#spring-data-redis)
   - [Spring Data Cassandra](#spring-data-cassandra)
12. [Spring Data REST](#spring-data-rest)
