...
2. [Инверсия управления и внедрение зависимостей](#инверсия-управления-и-внедрение-зависимостей)
3. [Конфигурация Spring-приложения](#конфигурация-spring-приложения)
...
5. [Области видимости бинов (Scopes)](#области-видимости-бинов-scopes)
   - [Основные scopes](#основные-scopes)
   - [Пользовательские scopes](#пользовательские-scopes)
6. [Архитектура Spring Container](#архитектура-spring-container)
...
8. [Spring Expression Language (SpEL)](#spring-expression-language-spel)
9. [Профили и условная конфигурация](#профили-и-условная-конфигурация)
   - [Spring Profiles](#spring-profiles)
   - [Условные бины (@Conditional)](#условные-бины-conditional)
10. [Управление ресурсами и окружением](#управление-ресурсами-и-окружением)
   - [Resource abstraction](#resource-abstraction)
   - [Environment и PropertySource](#environment-и-propertysource)
11. [События приложения](#события-приложения)
12. [Интернационализация (i18n)](#интернационализация-i18n)
13. [Тестирование Spring-приложений](#тестирование-spring-приложений)
14. [Инструменты и диагностика](#инструменты-и-диагностика)
