...
2. [Философия "Convention over Configuration"](#философия-convention-over-configuration)
3. [Автоконфигурация Spring Boot](#автоконфигурация-spring-boot)
   - [Механизм работы](#механизм-работы)
   - [Управление автоконфигурацией](#управление-автоконфигурацией)
4. [Spring Boot Starters](#spring-boot-starters)
   - [Популярные стартеры](#популярные-стартеры)
   - [Структура стартера](#структура-стартера)
   - [Создание собственного стартера](#создание-собственного-стартера)
5. [Структура Spring Boot приложения](#структура-spring-boot-приложения)
   - [Типичная структура проекта](#типичная-структура-проекта)
   - [Точка входа (@SpringBootApplication)](#точка-входа-springbootapplication)
   - [Настройка SpringApplication](#настройка-springapplication)
   - [Встроенные серверы](#встроенные-серверы)
6. [Профили и внешняя конфигурация](#профили-и-внешняя-конфигурация)
   ...
   - [Внешние конфигурационные файлы](#внешние-конфигурационные-файлы)
   - [Работа с конфигурацией в коде](#работа-с-конфигурацией-в-коде)
...
7. [Spring Boot Actuator](#spring-boot-actuator)
   - [Подключение Actuator](#подключение-actuator)
   - [Основные эндпоинты](#основные-эндпоинты)
   - [Настройка доступа к эндпоинтам](#настройка-доступа-к-эндпоинтам)
   - [Custom Health Indicators](#custom-health-indicators)
   - [Custom Metrics](#custom-metrics)
8. [Создание Executable JAR и развертывание](#создание-executable-jar-и-развертывание)
   - [Maven](#maven)
   - [Gradle](#gradle)
   - [Развертывание в виде WAR](#развертывание-в-виде-war)
   - [Layered JARs для Docker](#layered-jars-для-docker)
9. [Работа с базами данных](#работа-с-базами-данных)
   - [Автоконфигурация DataSource](#автоконфигурация-datasource)
   - [Использование JPA/Hibernate](#использование-jpahibernate)
   - [Инициализация БД](#инициализация-бд)
10. [REST API с Spring Boot](#rest-api-с-spring-boot)
   - [Создание REST-контроллера](#создание-rest-контроллера)
   - [Валидация](#валидация)
   - [Обработка исключений](#обработка-исключений)
   - [CORS Configuration](#cors-configuration)
   - [Content Negotiation](#content-negotiation)
11. [Безопасность с Spring Security](#безопасность-с-spring-security)
...
12. [Тестирование Spring Boot приложений](#тестирование-spring-boot-приложений)
   - [Unit-тесты сервисов](#unit-тесты-сервисов)
   - [Интеграционные тесты контроллеров](#интеграционные-тесты-контроллеров)
   - [Тестирование с реальной БД](#тестирование-с-реальной-бд)
   - [Тестирование только слоя данных](#тестирование-только-слоя-данных)
   - [Тестирование только веб-слоя](#тестирование-только-веб-слоя)
13. [Кеширование](#кеширование)
   - [Включение кеширования](#включение-кеширования)
   - [Использование кеша](#использование-кеша)
   - [Интеграция с Redis](#интеграция-с-redis)
14. [Асинхронная обработка](#асинхронная-обработка)
   - [Включение async](#включение-async)
   - [Асинхронные методы](#асинхронные-методы)
   - [Настройка Executor](#настройка-executor)
15. [Scheduled Tasks](#scheduled-tasks)
   - [Включение планирования](#включение-планирования)
