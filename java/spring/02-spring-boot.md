...
1. [Философия "Convention over Configuration"](#философия-convention-over-configuration)
2. [Автоконфигурация Spring Boot](#автоконфигурация-spring-boot)
...
4. [Структура Spring Boot приложения](#структура-spring-boot-приложения)
...
5. [Профили и внешняя конфигурация](#профили-и-внешняя-конфигурация)
...
7. [Создание Executable JAR и развертывание](#создание-executable-jar-и-развертывание)
   - [Maven](#maven)
   - [Gradle](#gradle)
   - [Развертывание в виде WAR](#развертывание-в-виде-war)
   - [Layered JARs для Docker](#layered-jars-для-docker)
8. [Работа с базами данных](#работа-с-базами-данных)
...
9. [REST API с Spring Boot](#rest-api-с-spring-boot)
...
13. [Асинхронная обработка](#асинхронная-обработка)
