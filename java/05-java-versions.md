...
- **Последняя проверка:** **4 августа 2026**.
- **Фокус ревизии:** хронология JDK 24–26 сверена с OpenJDK JEP Index и release notes; для каждого JEP явно указан статус возможности в соответствующем релизе.
