...
2. [Что такое Kubernetes](#что-такое-kubernetes)
   - [Ключевые характеристики:](#ключевые-характеристики)
3. [Зачем нужен Kubernetes](#зачем-нужен-kubernetes)
   - [Проблемы, которые решает Kubernetes:](#проблемы-которые-решает-kubernetes)
4. [История и эволюция](#история-и-эволюция)
   - [Хронология развития:](#хронология-развития)
   - [Влияние на индустрию:](#влияние-на-индустрию)
5. [Основные концепции](#основные-концепции)
   - [1. Кластер (Cluster)](#1-кластер-cluster)
   - [2. Node (Узел)](#2-node-узел)
   - [3. Pod](#3-pod)
   - [4. Deployment](#4-deployment)
   - [5. Service](#5-service)
   - [6. Namespace](#6-namespace)
6. [Архитектура на высоком уровне](#архитектура-на-высоком-уровне)
7. [Установка и первые шаги](#установка-и-первые-шаги)
   - [Варианты локальной установки:](#варианты-локальной-установки)
   - [Установка kubectl](#установка-kubectl)
   - [Проверка подключения к кластеру](#проверка-подключения-к-кластеру)
8. [Первое приложение в Kubernetes](#первое-приложение-в-kubernetes)
   - [Создание простого Deployment](#создание-простого-deployment)
   - [Создание Service для доступа](#создание-service-для-доступа)
   - [Масштабирование приложения](#масштабирование-приложения)
   - [Обновление приложения](#обновление-приложения)
9. [Основные команды kubectl](#основные-команды-kubectl)
   - [Работа с ресурсами](#работа-с-ресурсами)
   - [Отладка и логи](#отладка-и-логи)
   - [Конфигурация и контекст](#конфигурация-и-контекст)
   - [Полезные алиасы](#полезные-алиасы)
10. [Server-Side Apply](#server-side-apply)
11. [Практические упражнения](#практические-упражнения)
   - [Упражнение 1: Развернуть приложение](#упражнение-1-развернуть-приложение)
   - [Упражнение 2: Масштабирование](#упражнение-2-масштабирование)
   - [Упражнение 3: Обновление приложения](#упражнение-3-обновление-приложения)
