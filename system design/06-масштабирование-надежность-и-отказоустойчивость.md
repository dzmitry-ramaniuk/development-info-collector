...
2. [Вертикальное и горизонтальное масштабирование](#вертикальное-и-горизонтальное-масштабирование)
3. [Load balancing и распределение трафика](#load-balancing-и-распределение-трафика)
   - [Упрощённая схема масштабирования request path](#упрощённая-схема-масштабирования-request-path)
4. [Устранение single points of failure](#устранение-single-points-of-failure)
5. [Graceful degradation и backpressure](#graceful-degradation-и-backpressure)
6. [Failover, disaster recovery и multi-region](#failover-disaster-recovery-и-multi-region)
7. [Capacity planning и bottleneck analysis](#capacity-planning-и-bottleneck-analysis)
8. [Практический production checklist](#практический-production-checklist)
9. [Вопросы для самопроверки](#вопросы-для-самопроверки)
10. [🔗 Связанные темы](#-связанные-темы)
...
- [Kubernetes](../kubernetes/README.html) — практический контекст для scale-out, readiness, rollout и self-healing
- [Мониторинг и логирование в Kubernetes](../kubernetes/05-мониторинг-логирование.html) — observability для production-систем
