...
2. [1. Основы транзакций](#1-основы-транзакций)
3. [2. Уровни изоляции](#2-уровни-изоляции)
4. [3. Типичные аномалии и их предотвращение](#3-типичные-аномалии-и-их-предотвращение)
5. [4. Блокировки](#4-блокировки)
...
6. [5. Управление конкурентным доступом](#5-управление-конкурентным-доступом)
7. [6. Двухфазные и распределённые транзакции](#6-двухфазные-и-распределённые-транзакции)
8. [7. Транзакции и WAL](#7-транзакции-и-wal)
9. [8. Взаимодействие с VACUUM](#8-взаимодействие-с-vacuum)
10. [9. Журналирование и наблюдение](#9-журналирование-и-наблюдение)
