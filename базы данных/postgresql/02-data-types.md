...
1. [1. Общие принципы выбора типов](#1-общие-принципы-выбора-типов)
2. [2. Числовые типы](#2-числовые-типы)
3. [3. Строковые и текстовые](#3-строковые-и-текстовые)
4. [4. Дата и время](#4-дата-и-время)
5. [5. Структурированные и полу-структурированные данные](#5-структурированные-и-полу-структурированные-данные)
6. [6. Специализированные типы](#6-специализированные-типы)
7. [7. Типы для статистики и аналитики](#7-типы-для-статистики-и-аналитики)
8. [8. Моделирование и схемы](#8-моделирование-и-схемы)
9. [9. Работа с типами в приложениях](#9-работа-с-типами-в-приложениях)
