...
2. [1. Зачем нужны индексы](#1-зачем-нужны-индексы)
3. [2. Основные типы индексов](#2-основные-типы-индексов)
4. [3. Проектирование индексов](#3-проектирование-индексов)
5. [4. Особенности конкретных типов](#4-особенности-конкретных-типов)
6. [5. Обслуживание и мониторинг](#5-обслуживание-и-мониторинг)
7. [6. Стратегии для специфических нагрузок](#6-стратегии-для-специфических-нагрузок)
8. [7. Диагностика производительности](#7-диагностика-производительности)
9. [8. Индексы и транзакции](#8-индексы-и-транзакции)
10. [9. Автоматизация и инструментирование](#9-автоматизация-и-инструментирование)
