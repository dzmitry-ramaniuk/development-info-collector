...
2. [1. Архитектура и хранение](#1-архитектура-и-хранение)
3. [2. Типы данных и моделирование](#2-типы-данных-и-моделирование)
4. [3. Запросы и планы](#3-запросы-и-планы)
5. [4. Транзакции и блокировки](#4-транзакции-и-блокировки)
6. [5. Эксплуатация](#5-эксплуатация)
7. [6. Дополнительные темы](#6-дополнительные-темы)
