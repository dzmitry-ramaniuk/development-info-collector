...
1. [1. Классификация запросов](#1-классификация-запросов)
2. [2. Стратегия написания запросов](#2-стратегия-написания-запросов)
3. [3. Инструменты анализа и мониторинга](#3-инструменты-анализа-и-мониторинга)
4. [4. Чтение планов выполнения](#4-чтение-планов-выполнения)
5. [5. Работа со статистикой](#5-работа-со-статистикой)
6. [6. Оптимизация запросов](#6-оптимизация-запросов)
7. [7. Сбор метрик и профилирование](#7-сбор-метрик-и-профилирование)
8. [8. Работа с временными файлами и памятью](#8-работа-с-временными-файлами-и-памятью)
9. [9. Примеры типичных расследований](#9-примеры-типичных-расследований)
