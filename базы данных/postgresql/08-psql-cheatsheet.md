...
2. [1. Подключение и базовые команды](#1-подключение-и-базовые-команды)
3. [2. Работа со схемой](#2-работа-со-схемой)
4. [3. Выполнение запросов](#3-выполнение-запросов)
5. [4. Диагностика и статистика](#4-диагностика-и-статистика)
6. [5. Работа с конфигурацией](#5-работа-с-конфигурацией)
7. [6. Администрирование](#6-администрирование)
8. [7. Журналирование и обслуживание](#7-журналирование-и-обслуживание)
9. [8. Полезные настройки `psql`](#8-полезные-настройки-psql)
10. [9. Быстрый troubleshooting workflow](#9-быстрый-troubleshooting-workflow)
11. [10. Мини-шпаргалка по EXPLAIN/ANALYZE](#10-мини-шпаргалка-по-explainanalyze)
12. [11. Резервное копирование и восстановление](#11-резервное-копирование-и-восстановление)
13. [12. Диагностика bloat и роста объектов](#12-диагностика-bloat-и-роста-объектов)
