...
2. [Введение](#введение)
3. [Партиционирование (Partitioning)](#партиционирование-partitioning)
...
4. [Шардинг (Sharding)](#шардинг-sharding)
...
5. [Best Practices](#best-practices)
   - [Для партиционирования](#для-партиционирования)
   - [Для шардинга](#для-шардинга)
6. [Вопросы для собеседования](#вопросы-для-собеседования)
