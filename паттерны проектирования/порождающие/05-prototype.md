...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Сложное создание объекта](#проблема-сложное-создание-объекта)
   - [Решение: Prototype](#решение-prototype)
4. [Структура паттерна](#структура-паттерна)
5. [Глубокое и поверхностное копирование](#глубокое-и-поверхностное-копирование)
   - [Поверхностное копирование (Shallow Copy)](#поверхностное-копирование-shallow-copy)
   - [Глубокое копирование (Deep Copy)](#глубокое-копирование-deep-copy)
6. [Реализация](#реализация)
   - [Пример 1: Реестр прототипов](#пример-1-реестр-прототипов)
   - [Пример 2: Копирование сложного объекта](#пример-2-копирование-сложного-объекта)
   - [Пример 3: Prototype с сериализацией](#пример-3-prototype-с-сериализацией)
7. [Примеры использования](#примеры-использования)
   - [Java Cloneable](#java-cloneable)
   - [Object.clone()](#objectclone)
   - [Копирование через конструктор (рекомендуется)](#копирование-через-конструктор-рекомендуется)
