...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Жесткая привязка к конкретным классам](#проблема-жесткая-привязка-к-конкретным-классам)
   - [Решение: Factory Method](#решение-factory-method)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Система логирования](#пример-1-система-логирования)
   - [Пример 2: Фабрика подключений к БД](#пример-2-фабрика-подключений-к-бд)
   - [Пример 3: Статический фабричный метод (Variation)](#пример-3-статический-фабричный-метод-variation)
6. [Примеры использования](#примеры-использования)
   - [Из Java Collections Framework](#из-java-collections-framework)
   - [Из java.util.Calendar](#из-javautilcalendar)
   - [Из java.text.NumberFormat](#из-javatextnumberformat)
   - [Из JDBC](#из-jdbc)
7. [Factory Method vs Constructor](#factory-method-vs-constructor)
   - [Преимущества фабричных методов над конструкторами](#преимущества-фабричных-методов-над-конструкторами)
