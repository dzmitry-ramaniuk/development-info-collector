...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Создание несовместимых объектов](#проблема-создание-несовместимых-объектов)
   - [Решение: Abstract Factory](#решение-abstract-factory)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Фабрика подключений к разным БД](#пример-1-фабрика-подключений-к-разным-бд)
   - [Пример 2: Фабрика документов](#пример-2-фабрика-документов)
   - [Пример 3: Фабрика тем UI](#пример-3-фабрика-тем-ui)
6. [Примеры использования](#примеры-использования)
   - [Java AWT/Swing](#java-awtswing)
   - [JDBC (неявно)](#jdbc-неявно)
   - [Spring Framework](#spring-framework)
7. [Abstract Factory vs Factory Method](#abstract-factory-vs-factory-method)
