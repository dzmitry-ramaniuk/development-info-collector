...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Телескопический конструктор](#проблема-телескопический-конструктор)
   - [Решение: Builder](#решение-builder)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: HTTP Request Builder](#пример-1-http-request-builder)
   - [Пример 2: SQL Query Builder](#пример-2-sql-query-builder)
   - [Пример 3: Pizza Builder (классический пример)](#пример-3-pizza-builder-классический-пример)
6. [Fluent Interface](#fluent-interface)
7. [Примеры использования](#примеры-использования)
   - [Из Java Core - StringBuilder](#из-java-core---stringbuilder)
   - [Из Java 8+ Stream API](#из-java-8-stream-api)
   - [Из Java HttpClient (Java 11+)](#из-java-httpclient-java-11)
   - [Из Spring Framework](#из-spring-framework)
8. [Lombok @Builder](#lombok-builder)
