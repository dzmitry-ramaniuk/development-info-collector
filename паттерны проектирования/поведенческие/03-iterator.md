...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Раскрытие внутренней структуры](#проблема-раскрытие-внутренней-структуры)
   - [Решение: Iterator](#решение-iterator)
...
6. [Внутренние vs Внешние итераторы](#внутренние-vs-внешние-итераторы)
   - [Внешний итератор (External Iterator)](#внешний-итератор-external-iterator)
   - [Внутренний итератор (Internal Iterator)](#внутренний-итератор-internal-iterator)
   - [Сравнение](#сравнение)
7. [Примеры из JDK](#примеры-из-jdk)
   - [1. java.util.Iterator](#1-javautiliterator)
   - [2. java.lang.Iterable и for-each](#2-javalangiterable-и-for-each)
   - [3. Stream API](#3-stream-api)
   - [4. ListIterator](#4-listiterator)
   - [5. Scanner](#5-scanner)
8. [Преимущества и недостатки](#преимущества-и-недостатки)
   - [Преимущества](#преимущества)
   - [Недостатки](#недостатки)
9. [Вопросы на собеседовании](#вопросы-на-собеседовании)
   - [1. Что такое паттерн Iterator?](#1-что-такое-паттерн-iterator)
   - [2. В чем разница между Iterator и Iterable?](#2-в-чем-разница-между-iterator-и-iterable)
   - [3. Что такое fail-fast и fail-safe итераторы?](#3-что-такое-fail-fast-и-fail-safe-итераторы)
   - [4. Как реализовать свой итератор?](#4-как-реализовать-свой-итератор)
   - [5. В чем разница между внешним и внутренним итератором?](#5-в-чем-разница-между-внешним-и-внутренним-итератором)
   - [6. Можно ли модифицировать коллекцию во время итерации?](#6-можно-ли-модифицировать-коллекцию-во-время-итерации)
   - [7. Как работает двунаправленный итератор (ListIterator)?](#7-как-работает-двунаправленный-итератор-listiterator)
   - [8. Как реализовать фильтрующий итератор?](#8-как-реализовать-фильтрующий-итератор)
   - [9. Как итератор используется в паттерне Composite?](#9-как-итератор-используется-в-паттерне-composite)
   - [10. Как тестировать итераторы?](#10-как-тестировать-итераторы)
