...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Жесткая связанность обработчиков](#проблема-жесткая-связанность-обработчиков)
   - [Решение: Chain of Responsibility](#решение-chain-of-responsibility)
...
6. [Примеры из JDK](#примеры-из-jdk)
   - [1. Java Servlet Filters](#1-java-servlet-filters)
   - [2. Exception Handling](#2-exception-handling)
   - [3. java.util.logging](#3-javautillogging)
   - [4. ClassLoader Delegation](#4-classloader-delegation)
7. [Преимущества и недостатки](#преимущества-и-недостатки)
   - [Преимущества](#преимущества)
   - [Недостатки](#недостатки)
8. [Вопросы на собеседовании](#вопросы-на-собеседовании)
   - [1. Что такое паттерн Chain of Responsibility?](#1-что-такое-паттерн-chain-of-responsibility)
   - [2. В чем отличие Chain of Responsibility от Decorator?](#2-в-чем-отличие-chain-of-responsibility-от-decorator)
   - [3. Когда следует использовать паттерн Chain of Responsibility?](#3-когда-следует-использовать-паттерн-chain-of-responsibility)
   - [4. Какие недостатки у паттерна Chain of Responsibility?](#4-какие-недостатки-у-паттерна-chain-of-responsibility)
   - [5. Как реализовать обязательную обработку запроса?](#5-как-реализовать-обязательную-обработку-запроса)
   - [6. В чем разница между Chain of Responsibility и Command?](#6-в-чем-разница-между-chain-of-responsibility-и-command)
   - [7. Как паттерн реализован в Java Servlet Filters?](#7-как-паттерн-реализован-в-java-servlet-filters)
   - [8. Можно ли комбинировать Chain of Responsibility с другими паттернами?](#8-можно-ли-комбинировать-chain-of-responsibility-с-другими-паттернами)
   - [9. Как тестировать код с Chain of Responsibility?](#9-как-тестировать-код-с-chain-of-responsibility)
   - [10. Как реализовать цепочку с возможностью множественной обработки?](#10-как-реализовать-цепочку-с-возможностью-множественной-обработки)
