...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Множественные условные операторы](#проблема-множественные-условные-операторы)
   - [Решение: Паттерн Strategy](#решение-паттерн-strategy)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Сортировка](#пример-1-сортировка)
   - [Пример 2: Валидация данных](#пример-2-валидация-данных)
   - [Пример 3: Стратегии сжатия](#пример-3-стратегии-сжатия)
6. [Примеры использования](#примеры-использования)
   - [Из Java Collections Framework](#из-java-collections-framework)
   - [Из Jakarta Servlet](#из-jakarta-servlet)
   - [Из LayoutManager в AWT/Swing](#из-layoutmanager-в-awtswing)
7. [Strategy vs State](#strategy-vs-state)
8. [Современный подход с лямбдами](#современный-подход-с-лямбдами)
   - [Старый подход (до Java 8)](#старый-подход-до-java-8)
   - [Новый подход (Java 8+)](#новый-подход-java-8)
   - [Пример: Фильтрация списка](#пример-фильтрация-списка)
...
[← Назад к разделу Поведенческие паттерны](README.html)
