...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Жесткая связанность объектов](#проблема-жесткая-связанность-объектов)
   - [Решение: Observer](#решение-observer)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Система событий с типизированными событиями](#пример-1-система-событий-с-типизированными-событиями)
   - [Пример 2: Property Change Listener (из Java Beans)](#пример-2-property-change-listener-из-java-beans)
   - [Пример 3: Push vs Pull модели](#пример-3-push-vs-pull-модели)
6. [Примеры использования](#примеры-использования)
   - [Java Swing/AWT Event Listeners](#java-swingawt-event-listeners)
   - [JavaFX Properties](#javafx-properties)
   - [Spring Framework Events](#spring-framework-events)
   - [Observable/Observer в Java (deprecated с Java 9)](#observableobserver-в-java-deprecated-с-java-9)
7. [Reactive Programming](#reactive-programming)
   - [RxJava пример](#rxjava-пример)
   - [Project Reactor (Spring WebFlux)](#project-reactor-spring-webflux)
