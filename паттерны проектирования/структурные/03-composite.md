...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Различная обработка простых и составных объектов](#проблема-различная-обработка-простых-и-составных-объектов)
   - [Решение: Composite](#решение-composite)
...
6. [Примеры в JDK и фреймворках](#примеры-в-jdk-и-фреймворках)
   - [AWT/Swing Components](#awtswing-components)
   - [Java Collections](#java-collections)
   - [XML DOM](#xml-dom)
   - [JavaFX Scene Graph](#javafx-scene-graph)
