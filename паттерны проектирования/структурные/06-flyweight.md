...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Расточительное использование памяти](#проблема-расточительное-использование-памяти)
   - [Решение: Flyweight](#решение-flyweight)
...
6. [Примеры в JDK](#примеры-в-jdk)
   - [Integer.valueOf() - кеш значений](#integervalueof---кеш-значений)
   - [String pool](#string-pool)
   - [Collections (Boolean, Byte)](#collections-boolean-byte)
   - [Character cache](#character-cache)
