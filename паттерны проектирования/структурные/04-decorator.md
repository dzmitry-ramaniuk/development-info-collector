...
3. [Проблема, которую решает](#проблема-которую-решает)
   - [Проблема: Комбинаторный взрыв подклассов](#проблема-комбинаторный-взрыв-подклассов)
   - [Решение: Decorator](#решение-decorator)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Логирование и кеширование](#пример-1-логирование-и-кеширование)
   - [Пример 2: Обработка текста](#пример-2-обработка-текста)
   - [Пример 3: Оконные компоненты (GUI)](#пример-3-оконные-компоненты-gui)
6. [Примеры использования](#примеры-использования)
   - [Java I/O Streams - классический пример Decorator](#java-io-streams---классический-пример-decorator)
   - [Java Collections - unmodifiable decorators](#java-collections---unmodifiable-decorators)
   - [Spring Framework](#spring-framework)
   - [Servlet Filters](#servlet-filters)
7. [Decorator vs Inheritance](#decorator-vs-inheritance)
