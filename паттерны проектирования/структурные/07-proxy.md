...
3. [Типы прокси](#типы-прокси)
   - [1. Виртуальный прокси (Virtual Proxy)](#1-виртуальный-прокси-virtual-proxy)
   - [2. Защищающий прокси (Protection Proxy)](#2-защищающий-прокси-protection-proxy)
   - [3. Удаленный прокси (Remote Proxy)](#3-удаленный-прокси-remote-proxy)
   - [4. Кеширующий прокси (Caching Proxy)](#4-кеширующий-прокси-caching-proxy)
   - [5. Умная ссылка (Smart Reference)](#5-умная-ссылка-smart-reference)
4. [Структура паттерна](#структура-паттерна)
5. [Реализация](#реализация)
   - [Пример 1: Защищающий прокси (Access Control)](#пример-1-защищающий-прокси-access-control)
   - [Пример 2: Кеширующий прокси](#пример-2-кеширующий-прокси)
   - [Пример 3: Логирующий прокси](#пример-3-логирующий-прокси)
   - [Пример 4: Умная ссылка (Reference Counting)](#пример-4-умная-ссылка-reference-counting)
6. [Динамические прокси в Java](#динамические-прокси-в-java)
   - [JDK Dynamic Proxy](#jdk-dynamic-proxy)
   - [CGLIB Proxy (для классов без интерфейсов)](#cglib-proxy-для-классов-без-интерфейсов)
7. [Примеры использования](#примеры-использования)
   - [Spring AOP](#spring-aop)
   - [Hibernate Lazy Loading](#hibernate-lazy-loading)
   - [Java RMI](#java-rmi)
8. [Proxy vs Decorator](#proxy-vs-decorator)
